...
Revision ID: 3808f78f4ddf
Revises: 
Create Date: 2024-11-23 19:01:38.575381
...
def upgrade() -> None:
    ...
    sa.Column('create_user', sa.String(length=20), nullable=True, comment='创建人'),
    sa.Column('update_user', sa.String(length=20), nullable=True, comment='修改人'),
